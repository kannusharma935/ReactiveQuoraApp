...
public class AnswerService {
    ...
    public Mono<AnswerResponseDTO> getAnswerById(String id){
        return answerRepository.findById(id).map(this::mapToResponseDTO)
    ...
    public Mono<AnswerResponseDTO> updateAnswer(String id,AnswerRequestDTO answerRequestDTO){
        return answerRepository.findById(id)
                ...
                }).map(this::mapToResponseDTO).switchIfEmpty(Mono.error(new RuntimeException("Answer not found with id:"+id)));
    }
